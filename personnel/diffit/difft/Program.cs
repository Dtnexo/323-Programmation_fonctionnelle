...
int ident = comparisons.ToArray().Length - diffLines.Count();
Console.WriteLine("il y a " + ident + " lignes identiques");
Console.WriteLine("il y a " + diffLines.Count() + " lignes différents");
